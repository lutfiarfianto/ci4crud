<section class="features13 cid-siso2vizT4" id="features14-g">
    ...
    <div class="card col-12 col-md-4 col-lg-2 p-3">
      <div class="card-wrapper">
        <div class="card-box align-center">
          ...
          <h4 class="card-title align-center mbr-black mbr-fonts-style display-7"><strong>Mata Kuliah</strong></h4>
        </div>
      </div>
    </div>
      ...
      <div class="card-wrapper">
        <div class="card-box align-center">
          <span class="mbr-iconfont mbri-paper-plane"
            style="color: rgb(255, 255, 255); fill: rgb(255, 255, 255);"></span>
          <h4 class="card-title align-center mbr-black mbr-fonts-style display-7"><strong>Pilih Soal</strong></h4>
        </div>
      </div>
    </div>
    <div class="card p-3 col-12 col-md-4 col-lg-2">
