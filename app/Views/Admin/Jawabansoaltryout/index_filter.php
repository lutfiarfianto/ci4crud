      ...
      <div class="modal-dialog" role="document ">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <?= form_open(site_url('Admin/Jawabansoaltryout/Filter'),['method'=>'get'])?>

            <div class="form-group row">
              <label class="col-sm-4 col-form-label">Soal</label>
              <div class="col-sm-8">
                <?= form_input(["name"=>"soal_tryout","class"=>"form-control","type"=>"text","placeholder"=>"Soal","value"=>$table_filter->soal_tryout]); ?>
              </div>
            </div>
