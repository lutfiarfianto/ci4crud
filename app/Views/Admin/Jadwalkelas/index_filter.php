      ...
      <div class="modal-dialog" role="document ">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <?= form_open(site_url('admin/Jadwalkelas/Filter'),['method'=>'get'])?>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <?= form_input(["name"=>"tanggal_jam","class"=>"form-control","type"=>"datetime","placeholder"=>"Tanggal Jam","value"=>$table_filter->tanggal_jam]); ?>
              </div>
            </div>
