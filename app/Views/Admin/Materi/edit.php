  ...
  <div class="card-body">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <div class="input-group mb-3">
          ...
          <?php if( $materi->url_thumbnail ) : ?>
          <div class="input-group-append">
            <a class="input-group-text image-popup-vertical-fit"
              href="<?= base_url('uploads/'.$materi->url_thumbnail) ?>">View</a>
          </div>
          <?php endif; ?>
        </div>
      </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <div class="input-group mb-3">
          <div class="custom-file">
            <?= form_upload(["name"=>"url_pdf","id"=>"url_pdf","type"=>"file","placeholder"=>"PDF File",'accept'=>'.pdf']) ?>
            <label class="custom-file-label" for="url_pdf">Choose file</label>
          </div>
          <?php if( $materi->url_pdf ) : ?>
          <div class="input-group-append">
            <a class="input-group-text image-popup-vertical-fit"
              href="<?= base_url('uploads/'.$materi->url_pdf) ?>">View</a>
          </div>
          <?php endif; ?>
        </div>
      </div>
